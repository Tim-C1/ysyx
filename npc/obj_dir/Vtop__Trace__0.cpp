...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->chgQData(oldp+19,((((- (QData)((IData)(
                                ...
                                << 0xcU) | (QData)((IData)(
                                                           (vlSelf->inst 
                                                            >> 0x14U))))),64);
    tracep->chgCData(oldp+21,((0x1fU & (vlSelf->inst 
                                        >> 0xfU))),5);
    tracep->chgCData(oldp+22,((0x1fU & (vlSelf->inst 
                                        >> 7U))),5);
    tracep->chgQData(oldp+23,((((4U >= (7U & (vlSelf->inst 
                                              >> 0xfU)))
                               ...
                               + (((- (QData)((IData)(
                                   ...
                                   << 0xcU) | (QData)((IData)(
                                                              (vlSelf->inst 
                                                               >> 0x14U)))))),64);
    tracep->chgQData(oldp+25,(((4U >= (7U & (vlSelf->inst 
                                             >> 0xfU)))
                                ? vlSelf->top__DOT__gpr__DOT__rf
                               [(7U & (vlSelf->inst 
                                       >> 0xfU))] : 0ULL)),64);
